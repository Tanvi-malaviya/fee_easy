<x-admin-layout title="Create Staff Department">
    <div class="py-0">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden p-6">
                <div class="border-b border-gray-100 pb-4 mb-5">
                    <h2 class="text-lg font-bold text-gray-900 leading-tight">Create Staff Department</h2>
                    <p class="text-[10px] font-bold text-primary uppercase tracking-widest mt-1">Add a new global department</p>
                </div>
