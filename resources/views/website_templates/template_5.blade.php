                        ...
                        <div class="space-y-3">
                            ...
                            <button @click="selectedPillar = 0"
                                ...
                                <div class="flex items-center gap-4">
                                    <span
                                        class="text-xs font-mono font-bold text-slate-400 group-hover:text-brand-secondary transition-colors">01</span>
                            ...
                            <button @click="selectedPillar = 1"
                                ...
                                <div class="flex items-center gap-4">
                                    <span
                                        class="text-xs font-mono font-bold text-slate-400 group-hover:text-brand-secondary transition-colors">02</span>
                                    <span class="text-lg group-hover:scale-110 transition-transform">🚀</span>
                                    <span class="text-sm font-bold text-brand-primary font-outfit dynamic-editable"
                            ...
                            <button @click="selectedPillar = 2"
                                ...
                                <div class="flex items-center gap-4">
                                    <span
                                        class="text-xs font-mono font-bold text-slate-400 group-hover:text-brand-secondary transition-colors">03</span>
