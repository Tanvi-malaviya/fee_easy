        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
                ...
                <div class="lg:col-span-8">
                    <div
                        class="bg-white rounded-[2.5rem] shadow-xl shadow-indigo-500/5 border border-gray-100 overflow-hidden transition-all duration-300">
                        <div class="p-8 sm:p-12">
                            <div class="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs font-semibold text-gray-400 uppercase tracking-widest mt-0.5">
                                        Prepare manual announcement</p>
                                </div>
                            </div>
                            ...
                            <form action="{{ route('broadcast.send') }}" method="POST" class="space-y-8">
                                ...
                                @endif
                                <div>
                                    <label for="title" class="block text-sm font-bold text-gray-700 mb-3">Announcement
                                        Title</label>
                                    <input type="text" id="title" name="title" required
                                        class="block w-full px-5 py-3 text-lg font-bold text-gray-900 bg-gray-50 border-transparent rounded-2xl focus:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all duration-300 placeholder:text-gray-300"
                                        placeholder="e.g. Scheduled System Upgrade">
                                </div>

                                <!-- Message Field -->
                                <div>
                                    <label for="message" class="block text-sm font-bold text-gray-700 mb-3">Message
                                        Content</label>
                                ...
                                <div x-data="{ target: 'all' }">
                                    ...
                                    <label class="block text-sm font-bold text-gray-700 mb-4">Select Target
                                        Audience</label>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div @click="target = 'all'"
                                            ...
                                            <p class="text-xs font-semibold text-gray-500 mt-1">Broadcast to every user
                                                in the database</p>
                                        </div>
                                        ...
                                        <div @click="target = 'active'"
                                            ...
                                            <p class="text-xs font-semibold text-gray-500 mt-1">Only users with
                                                currently active plans</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="lg:col-span-4 space-y-6">
                    ...
                    <div
                        class="bg-white rounded-[2.5rem] shadow-xl shadow-indigo-500/5 border border-gray-100 overflow-hidden">
                        ...
                        <div class="divide-y divide-gray-50">
                                ...
                                <div class="p-4 hover:bg-indigo-50/30 transition-colors cursor-default group">
                                    <div class="flex gap-4">
                                        <div class="flex-shrink-0 flex flex-col items-center">
                                            <div
                                                class="w-2.5 h-2.5 rounded-full bg-emerald-500 border-4 border-emerald-100">
                                            </div>
                                            <div class="w-0.5 h-full bg-gray-100 my-2"></div>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-start justify-between mb-1">
                                                <h4 class="text-sm font-extrabold text-gray-900 truncate pr-4">
                                                    {{ $notification->title }}</h4>
                                                <span
                                                    class="text-[9px] font-bold text-gray-400 whitespace-nowrap uppercase">{{ $notification->created_at->diffForHumans(null, true) }}</span>
                                            </div>
                                            <p class="text-xs font-medium text-gray-500 line-clamp-2 leading-relaxed mb-4">
                                                {{ $notification->message }}</p>
                                            <div class="flex items-center justify-between">
                                                <div class="flex flex-col">
                                                    <span
                                                        class="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">{{ $notification->created_at->format('M d, Y') }}</span>
                                                    <span
                                                        class="text-[9px] font-medium text-gray-400 uppercase">{{ $notification->created_at->format('h:i A') }}</span>
                                                </div>
                                                <div
                                                    class="px-3 py-1 bg-emerald-50 text-emerald-700 text-[9px] font-black uppercase tracking-widest rounded-full border border-emerald-100 group-hover:bg-emerald-500 group-hover:text-white transition-colors">
                                                    Sent
                                                </div>
                                            </div>
                                        </div>
                            ...
                            @empty
                                <div class="py-20 flex flex-col items-center justify-center text-center px-8">
                                    ...
                                    <p class="text-xs font-medium text-gray-400 mt-2 leading-relaxed">Your broadcast history
                                        will appear here once you send your first announcement.</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
