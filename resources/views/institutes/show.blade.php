    ...
    <div class="max-w-7xl mx-auto"
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-y-3.5 gap-x-6 flex-grow">
                    <div><span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Institute</span>
                        <div class="flex items-center gap-2 mt-1 flex-wrap">
                            ...
                            <span
                                class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[8px] font-black uppercase tracking-wider whitespace-nowrap @if($institute->status == 'active') bg-emerald-50 text-emerald-600 border border-emerald-100 @elseif($institute->status == 'suspended') bg-amber-50 text-amber-600 border border-amber-100 @else bg-red-50 text-red-600 border border-red-100 @endif">
                                <span
        ...
        <div class="space-y-1 ">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="p-0">
                                            <x-empty-state title="No subscriptions found"
                                                subtitle="No subscription records found for this institute." icon="fees"
                                                plain="true" class="py-12" />
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden"
                    ...
                    @if($institute->students->isEmpty())
                        <x-empty-state title="No students found"
                            subtitle="No student admissions records found for this institute." icon="students" plain="true"
                            class="py-16" />
                    @else
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="p-0">
                                                <x-empty-state title="No staff found"
                                                    subtitle="No staff records found for this institute." icon="teacher"
                                                    plain="true" class="py-12" />
                                            </td>
                                        </tr>
                                    @endforelse
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="p-0">
                                                <x-empty-state title="No attendance records"
                                                    subtitle="No attendance records found for this institute's staff."
                                                    icon="teacher" plain="true" class="py-12" />
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            ...
                            <table class="w-full text-left">
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="p-0">
                                                <x-empty-state title="No salary records"
            ...
            <div x-show="activeTab === 'batches'" style="display:none">
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden"
                    ...
                    <div class="p-4 border-b border-gray-50 flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Total:
                            {{ $stats['batches_count'] }} Batches</span>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full text-left">
                            <thead class="bg-gray-50/50">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                @forelse($institute->batches as $i => $batch)
                                    <tr class="hover:bg-gray-50/50 transition delete-item" x-show="show({{ $i }})">
                                        ...
                                        <td class="px-4 py-2.5"><span
                                                class="text-[11px] font-bold text-gray-500">{{ $batch->subject ?? '—' }}</span>
                                        </td>
                                        <td class="px-4 py-2.5">
                                            @if($batch->start_time || $batch->end_time)
                                                <span
                                                    class="text-[11px] font-bold text-primary bg-orange-50 px-2 py-1 rounded-lg border border-orange-100">{{ $batch->start_time ?? '?' }}
                                                    – {{ $batch->end_time ?? '?' }}</span>
                                            @else
                                        ...
                                        <td class="px-4 py-2.5"><span
                                                class="text-[11px] font-black text-gray-700">₹{{ number_format($batch->fees ?? 0) }}</span>
                                        </td>
                                        <td class="px-4 py-2.5"><span
                                                class="text-sm font-black text-gray-900">{{ $batch->students_count }}</span>
                                        </td>
                                        <td class="px-4 py-2.5 text-right whitespace-nowrap">
                                            <a href="{{ route('institutes.batches.show', [$institute, $batch]) }}"
                                                title="View Batch Details"
                                                class="text-primary hover:text-orange-700 transition-colors duration-200 p-1.5 rounded-lg hover:bg-orange-100 inline-block align-middle mr-1">
                                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                                    ...
                                    <tr>
                                        <td colspan="6" class="p-0">
                                            <x-empty-state title="No batches found"
                                                subtitle="No batch records found for this institute." icon="notes"
                                                plain="true" class="py-12" />
                                        </td>
                                    </tr>
                                @endforelse
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm flex flex-col overflow-hidden"
                        ...
                        <div class="p-4 border-b border-gray-50 bg-emerald-50/30 shrink-0">
                            <h4 class="text-sm font-black text-emerald-600 uppercase tracking-widest">Recent Fee
                                Collections</h4>
                        </div>
                                        ...
                                        <tr class="hover:bg-gray-50/50 transition" x-show="show({{ $i }})">
                                            <td class="px-6 py-4">
                                                <div class="text-sm font-bold text-gray-900">
                                                    {{ $fee->student->name ?? 'Student' }}</div>
                                                <div class="text-[10px] text-gray-400">
                                                    {{ $fee->created_at->format('M d, Y') }}</div>
                                            </td>
                                            <td class="px-6 py-4 text-right">
                                                <div class="text-sm font-black text-emerald-600">
                                                    +₹{{ number_format($fee->paid_amount) }}</div>
                                                <div class="text-[10px] font-bold text-gray-400 uppercase">
                                                    {{ $fee->payment_method ?? 'Offline' }}</div>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="2"
                                                class="px-6 py-8 text-center text-gray-400 font-bold text-xs uppercase">No
                                                fees collected yet</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                                        ...
                                        <tr class="hover:bg-gray-50/50 transition" x-show="show({{ $i }})">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                ...
                                                <div class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                                    {{ $expense->category->name ?? 'General' }}</div>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="2"
                                                class="px-6 py-8 text-center text-gray-400 font-bold text-xs uppercase tracking-widest">
            ...
            <div x-show="activeTab === 'leads'" style="display:none">
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden"
                    ...
                    <div class="p-2 pl-4 border-b border-gray-50 flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Total:
                            {{ $stats['leads_count'] }} Leads</span>
                    </div>

                    <div class="p-2 bg-gray-50/30">
                        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-2">
                            @forelse($institute->leads as $i => $lead)
                                <div class="bg-white rounded-xl border border-gray-200 p-3.5 shadow-sm relative transition hover:shadow-md"
                                    x-show="show({{ $i }})">
                                    ...
                                    <div class="flex items-center gap-3 mb-3 pr-2">
                                        <div
                                            class="h-10 w-10 bg-orange-50 rounded-xl flex items-center justify-center text-primary font-black text-sm border border-orange-100 shrink-0">
                                            {{ substr(strtoupper(preg_replace('/[^a-zA-Z]/', '', $lead->full_name)), 0, 2) ?: 'LD' }}
                                        </div>
                                        <div class="overflow-hidden">
                                            <h4 class="text-sm font-bold text-gray-900 truncate"
                                                title="{{ $lead->full_name }}">{{ $lead->full_name }}</h4>
                                            <p class="text-[10px] font-bold text-gray-400 truncate">
                                                {{ $lead->course_selection ?? 'General Inquiry' }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-y-2 gap-x-2 text-xs">
                                        <div>
                                            <span
                                                class="flex items-center gap-1 text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">
                                        ...
                                        <div>
                                            ...
                                            <span
                                                class="font-bold text-gray-700 break-all block">{{ $lead->email ?? 'N/A' }}</span>
                                        </div>
                                        <div>
                                            <span
                                                class="flex items-center gap-1 text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <span
                                                class="font-medium text-gray-600 leading-relaxed">{{ $lead->address ?? 'N/A' }}</span>
                                        </div>
                                        <div
                                            class="col-span-2 mt-1 pt-2 border-t border-gray-100 flex justify-between items-center">
                            ...
                            @empty
                                <div class="col-span-full p-0">
                                    <x-empty-state title="No leads found" subtitle="No leads found for this institute."
                    ...
                    <div class="p-3 bg-gray-50/30">
                        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-1">
                            @forelse($institute->dailyUpdates as $i => $update)
                                ...
                                @endphp
                                <div class="bg-white rounded-xl border border-gray-200 p-3 shadow-sm hover:shadow-md transition relative flex flex-col"
                                    x-show="show({{ $i }})">
                                    <div class="flex items-start justify-between gap-2 mb-2">
                                        <div class="flex items-center gap-2 overflow-hidden">
                                            <div
                                                class="h-8 w-8 {{ $iconColor }} rounded-lg shadow-sm flex items-center justify-center shrink-0">
                                            ...
                                            <div class="overflow-hidden">
                                                <h4 class="text-sm font-bold text-gray-900 truncate"
                                                    title="{{ $update->topic ?? $update->category }}">
                                                    {{ $update->topic ?? $update->category ?? 'Update' }}</h4>
                                                <span
                                                    class="text-[9px] font-black {{ $colorClasses }} border px-1.5 py-0.5 rounded uppercase tracking-widest mt-0.5 inline-block">{{ strtoupper($cat) }}</span>
                                            </div>
                                        </div>
                                    </div>

                                    <p
                                        class="text-[11px] text-gray-500 leading-relaxed font-medium mb-2 flex-1 line-clamp-2 break-words">
                                        {{ $update->description }}</p>

                                    <div class="mt-auto pt-2 border-t border-gray-50 flex items-center justify-between">
                                        <div
                                            class="flex items-center gap-1.5 text-[9px] font-bold text-gray-400 uppercase tracking-widest">
                                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                            </svg>
                                            Target: <span class="text-gray-600 truncate max-w-[80px]"
                                                title="{{ $targetValue }}">{{ $targetValue }}</span>
                                        </div>
                                        <div
                                            class="flex items-center gap-1.5 text-[9px] font-bold text-gray-400 uppercase tracking-widest">
                                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @empty
                                <div class="col-span-full p-0">
                                    <x-empty-state title="No updates published yet"
                                        subtitle="No daily updates or announcements found for this institute." icon="notes"
                                        plain="true" class="py-12" />
                                </div>
                            @endforelse
                        </div>
            ...
            <div x-show="activeTab === 'notes'" style="display:none">
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden"
                    ...
                    <div class="p-4 border-b border-gray-50 flex items-center justify-between">
                        <h4 class="text-sm font-black text-gray-900 uppercase tracking-widest">Study Materials & Notes
                        </h4>
                        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Total:
                            {{ $stats['notes_count'] }} Notes</span>
                    </div>
                    <div class="p-4 bg-gray-50/30">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
                            @forelse($institute->notes as $i => $note)
                                ...
                                @endphp
                                <div class="group bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden flex flex-col h-[320px]"
                                    x-show="show({{ $i }})">
                                    @if($note->image_url)
                                    ...
                                    @else
                                        <div
                                            class="w-full h-32 bg-gradient-to-br from-slate-50 to-slate-100/50 flex items-center justify-center relative overflow-hidden shrink-0 border-b border-slate-50">
                                    ...
                                    <div
                                        class="absolute top-3 right-3 p-2 rounded-full bg-white/90 backdrop-blur-sm shadow-sm z-20 {{ $note->is_bookmarked ? 'text-[#ff6c00]' : 'text-slate-300' }}">
                                        <svg class="w-4 h-4" fill="{{ $note->is_bookmarked ? 'currentColor' : 'none' }}"
                                    ...
                                    <div class="p-4 flex flex-col flex-1">
                                        <div class="mb-2">
                                            <span
                                                class="px-2 py-0.5 {{ $catColors }} rounded-md text-[8px] font-black uppercase tracking-widest inline-block">
                                                {{ $catName }}
                                            </span>
                                        </div>
                                        ...
                                        <div
                                            class="text-[13px] text-slate-500 font-medium leading-relaxed break-words line-clamp-4 mb-4">
                                            {{ $cleanPreview }}
                                        </div>

                                        <div
                                            class="flex items-center justify-between pt-3 border-t border-slate-50 mt-auto">
                                            <span
                                                class="text-[9px] font-bold text-slate-400 uppercase tracking-widest">{{ strtoupper(str_replace([' seconds', ' minutes', ' hours', ' days', ' weeks', ' months', ' years'], ['s', 'm', 'h', 'd', 'w', 'mo', 'y'], $note->created_at->diffForHumans(null, true))) }}
                                                AGO</span>
                            ...
                            @empty
                                <div class="col-span-full p-0">
                                    <x-empty-state title="No notes uploaded yet"
                                        subtitle="No notes or study materials found for this institute." icon="notes"
                                        plain="true" class="py-12" />
                                </div>
                            @endforelse
                        </div>
            ...
            <div x-show="activeTab === 'chats'" style="display:none">
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden"
                    ...
                    <div class="p-4 border-b border-gray-50 flex items-center justify-between">
                        <h4 class="text-sm font-black text-gray-900 uppercase tracking-widest">Messaging & WhatsApp Logs
                        </h4>
                        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Total:
                            {{ $logsCount }} Logs</span>
                    </div>
                            ...
                            <tbody class="divide-y divide-gray-50">
                                @forelse($institute->whatsappLogs as $i => $log)
                                    <tr class="hover:bg-gray-50/50 transition" x-show="show({{ $i }})">
                                        <td class="px-6 py-4">
                                            <div class="text-sm font-bold text-gray-900">
                                                {{ $log->recipient_name ?? $log->recipient_phone }}</div>
                                            <div class="text-[10px] text-gray-400">
                                                {{ $log->created_at->format('M d, H:i') }}</div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <p class="text-xs text-gray-600 line-clamp-1 max-w-xs">{{ $log->message }}</p>
                                        </td>
                                        <td class="px-6 py-4"><span
                                                class="text-[10px] font-black text-gray-400 uppercase tracking-widest">{{ $log->type }}</span>
                                        </td>
                                        <td class="px-6 py-4"><span
                                                class="px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider @if($log->status == 'sent') bg-emerald-50 text-emerald-600 border border-emerald-100 @elseif($log->status == 'failed') bg-red-50 text-red-600 border border-red-100 @else bg-blue-50 text-blue-600 border border-blue-100 @endif">{{ $log->status }}</span>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="4" class="p-0">
                                            <x-empty-state title="No chat logs available"
        ...
        <div x-show="deleteModal" x-transition:enter="transition ease-out duration-200"
            ...
            <div x-show="deleteModal" x-transition:enter="transition ease-out duration-200"
                ...
                {{-- Icon --}}
                <div
                    class="flex items-center justify-center w-14 h-14 bg-orange-50 rounded-2xl mx-auto mb-4 border border-orange-100">
                ...
                {{-- Title --}}
                <h3 class="text-base font-black text-gray-900 text-center tracking-tight">Delete <span
                        x-text="deleteType"></span>?</h3>
