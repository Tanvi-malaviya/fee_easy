<x-admin-layout title="Edit Institute">
    ...
    <div class="max-w-5xl mx-auto">
        @php
            $backUrl = request('from') === 'index' ? route('institutes.index') : route('institutes.show', $institute);
        @endphp
        <div class="flex items-center gap-4 mb-2">
            <a href="{{ $backUrl }}"
                class="relative inline-flex items-center justify-center gap-2 px-4 py-2 bg-primary text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:opacity-90 transition active:scale-95 shadow-lg shadow-primary/20 min-w-[120px]">
        ...
        <form action="{{ route('institutes.update', [$institute, 'from' => request('from')]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-visible">
                <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div>
                        <label for="institute_name"
                            class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Institute
                            Name <span class="text-red-500">*</span></label>
                        <input type="text" name="institute_name" id="institute_name"
                            value="{{ old('institute_name', $institute->institute_name) }}" required
                    ...
                    <div>
                        <label for="name"
                            class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Owner Full
                            Name <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="email"
                            class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Contact
                            Email <span class="text-red-500">*</span></label>
                        <input type="email" name="email" id="email" value="{{ old('email', $institute->email) }}"
                    ...
                    <div class="flex items-start space-x-3">
                        <div class="flex-1">
                            <label for="logo"
                                class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Update
                                Logo</label>
                        ...
                        <div id="logo-preview">
                            @if(old('logo_base64'))
                                <div class="mt-4">
                                    <img src="{{ old('logo_base64') }}"
                                        class="h-10 w-10 rounded-lg object-cover border border-gray-200 shadow-sm">
                                </div>
                            ...
                            @else
                                <div
                                    class="mt-4 w-10 h-10 rounded-lg bg-gray-50 border border-gray-100 flex items-center justify-center">
                    ...
                    <div>
                        <label for="status"
                            class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Status
                            <span class="text-red-500">*</span></label>
                        <select name="status" id="status" required onchange="clearError(this)"
                ...
                <div class="px-5 pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div class="md:col-span-2">
                            <label for="address"
                                class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Full
                                Address</label>
                            <input type="text" name="address" id="address"
                                value="{{ old('address', $institute->address) }}" oninput="clearError(this)"
                                class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary focus:ring-primary transition px-4 py-1.5 border text-sm font-bold text-gray-900 bg-gray-50 focus:bg-white @error('address') border-red-500 @enderror"
                        ...
                        <div>
                            <label for="state"
                                class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">State /
                                Province</label>
                            <select name="state" id="state"
                                onchange="clearError(document.getElementById('state'))"></select>
                        </div>

                        <div>
                            <label for="city"
                                class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">City</label>
                            <select name="city" id="city"
                                onchange="clearError(document.getElementById('city'))"></select>
                        </div>

                        <div>
                            <label for="pincode"
                                class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Pin
                                Code / Zip</label>
                            <input type="text" name="pincode" id="pincode"
                                value="{{ old('pincode', $institute->pincode) }}" oninput="clearError(this)"
                ...
                <div class="px-5 pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div>
                            <label for="website"
                                class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Website
                                URL</label>
                            <input type="url" name="website" id="website"
                                value="{{ old('website', $institute->website) }}" oninput="clearError(this)"
                                class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary focus:ring-primary transition px-4 py-1.5 border text-sm font-bold text-gray-900 bg-gray-50 focus:bg-white @error('website') border-red-500 @enderror"
                        ...
                        <div>
                            <label for="youtube"
                                class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">YouTube
                                Channel</label>
                            <input type="url" name="youtube" id="youtube"
                                value="{{ old('youtube', $institute->youtube) }}" oninput="clearError(this)"
                                class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary focus:ring-primary transition px-4 py-1.5 border text-sm font-bold text-gray-900 bg-gray-50 focus:bg-white @error('youtube') border-red-500 @enderror"
                        ...
                        <div>
                            <label for="instagram"
                                class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Instagram
                                Profile</label>
                            <input type="url" name="instagram" id="instagram"
                                value="{{ old('instagram', $institute->instagram) }}" oninput="clearError(this)"
                                class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary focus:ring-primary transition px-4 py-1.5 border text-sm font-bold text-gray-900 bg-gray-50 focus:bg-white @error('instagram') border-red-500 @enderror"
                ...
                <div class="bg-gray-50 px-8 py-5 border-t border-gray-200 flex justify-end gap-3 rounded-b-3xl">
                    <a href="{{ $backUrl }}" onclick="showBtnLoader(this)"
                        class="relative inline-flex items-center justify-center px-8 py-3 border border-gray-100 rounded-xl text-xs font-bold uppercase tracking-widest text-gray-500 hover:bg-gray-100 transition shadow-sm bg-white active:scale-95 min-w-[120px]">
                    ...
                    <button type="submit" onclick="showBtnLoader(this)"
                        class="relative inline-flex items-center justify-center px-8 py-3 bg-primary text-white rounded-xl shadow-lg shadow-primary/20 hover:opacity-90 focus:outline-none transition font-bold text-xs uppercase tracking-widest active:scale-95 min-w-[180px]">
