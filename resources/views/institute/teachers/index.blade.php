...
@section('content')
    <div class="space-y-6 max-w-[1600px] mx-auto pb-10">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div>
                <h1 class="text-xl font-semibold text-slate-800 tracking-tight">Teacher Faculty</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm flex items-center space-x-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">Total
                        Faculty</p>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-8 border-b border-slate-50 flex items-center justify-between bg-slate-50/20">
                ...
                <div id="loading-spinner"
                    class="hidden h-5 w-5 border-2 border-slate-200 border-t-blue-600 rounded-full animate-spin"></div>
            </div>
            ...
            <div id="pagination-container"
                class="px-8 py-6 bg-slate-50/20 flex items-center justify-between border-t border-slate-50"></div>
        </div>
    </div>
            ...
            <div class="p-10">
                ...
                <form id="teacher-form" class="space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-2">
                            <label
                                class="text-[11px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">Subject</label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-2">
                            <label
                                class="text-[11px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">Status</label>
