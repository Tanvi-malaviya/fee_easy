                                ...
                                <div class="flex gap-2">
                                    <div class="relative flex-1">
                                        <input type="text" id="lead-search" placeholder="Search leads..."
                                            class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-100 rounded-2xl text-xs font-semibold focus:ring-2 focus:ring-primary/20 transition-all outline-none text-slate-600 placeholder-slate-400">

                                        <svg class="w-4 h-4 absolute left-3.5 top-3.5 text-slate-400" fill="none"
                                    ...
                                    <button onclick="fetchLeads()"
                                        class="px-4 py-2.5 bg-primary text-white rounded-2xl hover:opacity-90 active:scale-95 transition-all flex items-center justify-center shadow-sm">
                            ...
                            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 sm:p-5 space-y-4">
                                ...
                                <div class="space-y-4 text-left">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label
                                                class="block text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Referrer</label>
                                            <p id="detail-referrer" class="text-xs font-bold text-slate-700">David Smith</p>
                                        </div>
                                    </div>
                                    <div>
                                        <label
