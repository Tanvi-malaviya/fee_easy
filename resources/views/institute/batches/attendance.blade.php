...
@section('content')
    ...
    <div class="max-w-7xl mx-auto pt-2 pb-24 px-4 sm:px-6">
        ...
        <nav class="flex flex-wrap items-center gap-y-1 gap-x-2 text-[10px] sm:text-[11px] font-black text-slate-400 uppercase tracking-[0.1em] sm:tracking-[0.2em] mb-2">
            ...
            <svg class="w-2.5 h-2.5 sm:w-3 sm:h-3 text-slate-300 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <!-- Date Picker -->
                <div class="bg-white px-4 py-2 rounded-xl border border-slate-100 shadow-sm flex flex-col items-stretch sm:items-end w-full sm:w-auto">
                    <div class="relative flex items-center justify-between sm:justify-end gap-3">
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Session Date</span>
                        <div onclick="openDatePicker()" class="relative flex items-center gap-1.5 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg px-2.5 py-1.5 cursor-pointer transition-all">
                            ...
                            <span id="display-date" class="text-xs font-bold text-slate-800">05/25/2026</span>
        ...
        <div class="bg-white rounded-xl p-3 mb-3 border border-slate-100 shadow-sm flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full lg:w-auto">
                <button onclick="markAllPresent()" class="px-4 py-2.5 sm:py-2 bg-slate-50 hover:bg-slate-100 text-slate-700 text-xs font-bold rounded-xl border border-slate-200 transition-all flex items-center justify-center gap-1.5 w-full sm:w-auto">
                    <svg class="w-3.5 h-3.5 text-emerald-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
                ...
                <button onclick="markAllAbsent()" class="px-4 py-2.5 sm:py-2 bg-slate-50 hover:bg-slate-100 text-slate-700 text-xs font-bold rounded-xl border border-slate-200 transition-all flex items-center justify-center gap-1.5 w-full sm:w-auto">
                    <svg class="w-3.5 h-3.5 text-rose-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
    ...
    <script>
        ...
        function updateDisplayDate() {
            ...
            if (input && display && input.value) {
                ...
                if (parts.length === 3) {
                    display.innerText = `${parts[1]}/${parts[2]}/${parts[0]}`;
                }
            }
        }
