            ...
            <div class="bg-white rounded-[1rem] shadow-xl border border-slate-100/50 p-5">
                ...
                <div class="flex flex-col md:flex-row items-start md:items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-[10px] text-slate-400 font-medium mt-0.5 leading-relaxed">Upload your official
                            institutional emblem. Recommended size is 512x512px. Supported formats: PNG, JPG (Max 2MB).</p>
                        ...
                        <div class="flex items-center gap-3 mt-2 text-[11px] font-bold">
                            <button type="button" onclick="document.getElementById('logo-input').click()"
                                class="text-[#ff6c00] hover:text-[#e05f00] flex items-center gap-1 transition-colors">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-1">
                        <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Institute
                            Name</label>
                        <input type="text" name="institute_name" id="field-institute_name"
                            placeholder="Enter Institute Name" class="input">
                    </div>
                    <div class="space-y-1">
                        <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Owner
                            Name</label>
            ...
            <div class="bg-white rounded-[1rem] shadow-xl border border-slate-100/50 p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-1 space-y-1">
                        <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Address Line
                            1</label>
                        <input type="text" name="address" id="field-address" placeholder="Flat, House no., Building"
                            class="input">
                    </div>
                    <div class="md:col-span-1 space-y-1">
                        <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Address Line
                        ...
                        <input type="text" name="address_line_2" id="field-address_line_2"
                            placeholder="Area, Street, Sector" class="input">
                    </div>
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="space-y-1">
                            <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">State /
                                Province</label>
                            <input type="text" name="state" id="field-state" placeholder="State" class="input">
                        </div>
                        <div class="space-y-1">
                            <label
                                class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Country</label>
                            <input type="text" name="country" id="field-country" placeholder="Country" class="input"
                                value="India">
                        </div>
                        <div class="space-y-1">
                            <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Pincode /
                                Zip</label>
