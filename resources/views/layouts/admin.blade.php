            ...
            <div class="mt-auto px-4 py-4 border-t border-gray-100 bg-white sticky bottom-0">
                ...
                <div class="space-y-1">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="w-full flex items-center px-4 py-2 text-[13px] font-bold text-rose-500 hover:bg-rose-50 rounded-lg group uppercase tracking-widest">
