    ...
    <div class="flex h-screen overflow-hidden">
        ...
        class="fixed inset-y-0 left-0 z-50 bg-white border-r border-gray-100 flex flex-col transform lg:translate-x-0 lg:static shadow-sm">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 w-full overflow-y-auto custom-scrollbar">
                ...
                <a href="{{ route('settings.index') }}" class="flex items-center px-4 py-2.5 {{ request()->routeIs('settings.index') ? 'bg-orange-50 text-orange-600' : 'text-gray-500 hover:bg-gray-50 hover:text-orange-600' }} rounded-lg transition-all group">
                    <svg class="w-5 h-5 flex-shrink-0" :class="{'mr-3': !sidebarCollapsed}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('settings.razorpay.index') }}" class="flex items-center px-4 py-2.5 {{ request()->routeIs('settings.razorpay.*') ? 'bg-orange-50 text-orange-600' : 'text-gray-500 hover:bg-gray-50 hover:text-orange-600' }} rounded-lg transition-all group">
                    <svg class="w-5 h-5 flex-shrink-0" :class="{'mr-3': !sidebarCollapsed}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('qr.analytics') }}" class="flex items-center px-4 py-2.5 {{ request()->routeIs('qr.*') ? 'bg-orange-50 text-orange-600' : 'text-gray-500 hover:bg-gray-50 hover:text-orange-600' }} rounded-lg transition-all group">
                    ...
                    <span x-show="!sidebarCollapsed" class="sidebar-text text-[13px] font-medium whitespace-nowrap">QR Analytics</span>
                </a>
            </nav>
